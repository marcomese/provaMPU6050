...
#elif defined EMPL_TARGET_STM32F4_HAL
#include "main.h"
#include "log.h"
   
#define i2c_write(slave_addr,reg_addr,length,data)   HAL_I2C_Mem_Write(&I2C_DEV,                 \
...
#define i2c_read(slave_addr,reg_addr,length,data)   HAL_I2C_Mem_Read(&I2C_DEV,                 \
                                                                     (uint16_t)(slave_addr<<1),\
                                                                     (uint16_t)reg_addr,       \
                                                                     I2C_ADDSIZE,              \
                                                                     (uint8_t*)data,           \
...
#define get_ms(count){ *count = HAL_GetTick(); }
#define log_i       MPL_LOGI
#define log_e       MPL_LOGE
#define min(a,b) ((a<b)?a:b)
